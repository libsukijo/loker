...
class Pinjam extends CI_Controller {
	...
	private function checkMahasiswa() {
		...
		if ($totData > 0) {
			...
			//insert log
			$this->insert_loker_log(array('message' => $message, 'nama' => $get_data_anggota['nama'], 'no_loker' => '','nim' => $this->input->post('nim') ), 2);
