   ...
   <div class="content-wrapper">
       ...
       <div class="content-header">
           <div class="container-fluid">
               <div class="row mb-2">
                   <div class="col-sm-6">
                       <h1 class="m-0"> Laporan Pengujung</h1>
                   </div>
                   <div class="col-sm-6">
                                                       ...
                                                       <form id="form-filter">
                                                           <div class="row">
                                                               <div class="col-md-6">
                                                                   ...
                                                                   <div class="form-group">
                                                                       <label>NIM</label>
                                                                       <input type="text" class="form-control" placeholder="Input Nim" id="nim">
                                                                   </div>
                                                               </div>
                                                               <div class="col-md-6">
                                                                   <div class="form-group">
                                                                       ...
                                                                       <select class="form-control" id="fakultas">
                                                                           ...
                                                                           <?php foreach ($fakultas as $fak) { ?>
                                                                               <option value="<?php echo $fak['fakultas'] ?>"><?php echo $fak['fakultas']  ?></option>
                                                                           <?php } ?>
                                                                       </select>
                                                                   </div>
                                                                   <!-- Date range -->
   ...
   <script type="text/javascript">
       $(document).ready(function() {
           ...
           table = $('#table').DataTable({
               ...
               "ajax": {
                   "url": "<?php echo site_url('admin/laporan/ajax_list') ?>",
                   'data': function(data) {
           ...
           $('#btn-excel').click(function() { //button rxcel event click
               ...
               location.href = "<?= base_url() ?>admin/laporan/export_excel?nama=" + nama + "&nim=" + nim + "&fakultas=" + fakultas + "&tanggal=" + tanggal;
           });
